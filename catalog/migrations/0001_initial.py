# Generated by Django 2.0.5 on 2018-05-16 03:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text=' Enter a book genre (science fiction, non-fiction, history ,romance)', max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
